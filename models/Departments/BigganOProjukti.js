...
const MetadataSchema = new Schema({
  bigID: { type: String, required: true, unique: true },
...
const SubcategorySchema = new Schema(
  ...
  { timestamps: true, collection: "bigganOProjukti" }
);

const BigganOProjukti = mongoose.model(
  "BigganOProjukti",
  SubcategorySchema,
  "bigganOProjukti"
);

module.exports = BigganOProjukti;
