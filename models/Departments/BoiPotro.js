...
const MetadataSchema = new Schema({
  boiID: { type: String, required: true, unique: true },
...
const SubcategorySchema = new Schema(
  ...
  { timestamps: true, collection: "boiPotro" }
);

const BoiPotro = mongoose.model("BoiPotro", SubcategorySchema, "boiPotro");

module.exports = BoiPotro;
